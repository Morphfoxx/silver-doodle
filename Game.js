...
images[0].src = "./Platform_2.png"; //für jedes Bild muss die Source gesetzt werden
images[1].src = "./Cat.png";
...
class Player {
  constructor() {
    //nötig, damit jeder neue "Player" die gleichen Werte annimmt
    this.position = {
      //Startposition
      x: 100,
      y: 400,
    ...
    this.velocity = {
      //Geschwindigkeit, hier fürs Fallen (da y 1 ist)
      x: 0,
      y: 1,
    };
...
function animate() {
  ...
  (c.fillStyle = "#3d354a"), c.fillRect(0, 0, canvas.width, canvas.height);
